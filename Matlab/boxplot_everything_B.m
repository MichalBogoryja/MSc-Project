...
label_txt = '';
g = [];
label_1 = strcat(label_txt,'1');
label_2 = strcat(label_txt,'2');
label_3 = strcat(label_txt,'3');
label_4 = strcat(label_txt,'4');
label_5 = strcat(label_txt,'5');
label_6 = strcat(label_txt,'6');
label_7 = strcat(label_txt,'7');
label_8 = strcat(label_txt,'8');
label_9 = strcat(label_txt,'9');
